...
const Header = () => {
  ...
  return (
    <motion.div className="flex flex-col justify-center items-center text-center  h-screen"
    ...
    viewport={{once:true}}>
      ...
      animate={{opacity:1,y:0}}>
        ...
        in seconds - just type, and watch magic happen
      </motion.p>
      ...
      <motion.div className="flex flex-wrap justify-center mt-16 gap-3"
       ...
       transition={{delay:1,duration:1}}>
        {Array(6).fill('').map((item,index)=>(
            <motion.img key={index} src={index % 2 == 0 ? assets.sample_img_2:assets.sample_img_1}  width={70} className="rounded hover:scale-105 transition-all duration-300 cursor-pointer max-sm-10" 
